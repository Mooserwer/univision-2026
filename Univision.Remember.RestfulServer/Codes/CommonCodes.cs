...
namespace Univision.Remember.RestfulServer.Codes
{
  ...
  public class ProjectHistoryStateCode
  {
    ...
    static ProjectHistoryStateCode()
    {
      ...
      ProjectHistoryStateCodes.Add(ProjectHistoryStateCode.fail, "탈락");
      ProjectHistoryStateCodes.Add(ProjectHistoryStateCode.selfdrop, "Self drop");
      ProjectHistoryStateCodes.Add(ProjectHistoryStateCode.no_intrest, "관심없음");
